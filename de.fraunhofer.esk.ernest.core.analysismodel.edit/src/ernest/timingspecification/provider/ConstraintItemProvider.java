...
/**
 * This is the item provider adapter for a {@link ernest.timingspecification.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TimingspecificationPackage.Literals.CONSTRAINT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addResultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_result_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_result_feature", "_UI_Constraint_type"),
				 TimingspecificationPackage.Literals.CONSTRAINT__RESULT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimingspecificationPackage.Literals.CONSTRAINT__CONST_VALID);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TimingspecificationPackage.Literals.CONSTRAINT__CONST_VALID,
				 TimingspecificationFactory.eINSTANCE.createConstraintValidation()));
	}
