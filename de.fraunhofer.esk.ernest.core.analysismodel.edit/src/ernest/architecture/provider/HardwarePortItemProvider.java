...
/**
 * This is the item provider adapter for a {@link ernest.architecture.HardwarePort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwarePortItemProvider extends PortItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwarePort_connectedTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwarePort_connectedTo_feature", "_UI_HardwarePort_type"),
				 ArchitecturePackage.Literals.HARDWARE_PORT__CONNECTED_TO,
				 true,
				 false,
				 true,
				 null,
