...
/**
 * This is the item provider adapter for a {@link ernest.architecture.Behavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorItemProvider 
	...
	protected void addTriggerPolicyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Behavior_triggerPolicy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Behavior_triggerPolicy_feature", "_UI_Behavior_type"),
				 ArchitecturePackage.Literals.BEHAVIOR__TRIGGER_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTriggerConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Behavior_triggerCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Behavior_triggerCondition_feature", "_UI_Behavior_type"),
				 ArchitecturePackage.Literals.BEHAVIOR__TRIGGER_CONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturePackage.Literals.BEHAVIOR__OPERATION,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Behavior)object).getBody();
