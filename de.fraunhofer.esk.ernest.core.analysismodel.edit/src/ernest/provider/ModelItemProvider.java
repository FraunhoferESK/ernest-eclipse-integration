...
/**
 * This is the item provider adapter for a {@link ernest.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ErnestPackage.Literals.MODEL__TITLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ErnestPackage.Literals.MODEL__STRUCTURE_MODEL);
			childrenFeatures.add(ErnestPackage.Literals.MODEL__TIMING_MODEL);
			childrenFeatures.add(ErnestPackage.Literals.MODEL__TRACING_RESULTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ErnestPackage.Literals.MODEL__STRUCTURE_MODEL,
				 ArchitectureFactory.eINSTANCE.createStructureModel()));

		newChildDescriptors.add
			(createChildParameter
				(ErnestPackage.Literals.MODEL__TIMING_MODEL,
				 TimingspecificationFactory.eINSTANCE.createTimingModel()));

		newChildDescriptors.add
			(createChildParameter
				(ErnestPackage.Literals.MODEL__TRACING_RESULTS,
				 TracingFactory.eINSTANCE.createTracingResults()));
	}
