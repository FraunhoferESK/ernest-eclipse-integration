 ...
 * </p>
 * <ul>
 *   <li>{@link ernest.architecture.impl.ConnectorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConnectorImpl extends ElementImpl implements Connector {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CONNECTOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArchitecturePackage.CONNECTOR__NAME:
				return getName();
		}
