...
public class ArchitectureFactoryImpl extends EFactoryImpl implements ArchitectureFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ArchitecturePackage.STRUCTURE_MODEL: return createStructureModel();
			case ArchitecturePackage.BEHAVIOR: return createBehavior();
			case ArchitecturePackage.FUNCTION: return createFunction();
			case ArchitecturePackage.ECU: return createECU();
			case ArchitecturePackage.BUS: return createBus();
			case ArchitecturePackage.SENSOR: return createSensor();
			case ArchitecturePackage.ACTUATOR: return createActuator();
			case ArchitecturePackage.ENVIRONMENT: return createEnvironment();
			case ArchitecturePackage.FLOW_PORT: return createFlowPort();
			case ArchitecturePackage.CS_PORT: return createCSPort();
			case ArchitecturePackage.INTERFACE: return createInterface();
			case ArchitecturePackage.OPERATION: return createOperation();
			case ArchitecturePackage.ARGUMENT: return createArgument();
			case ArchitecturePackage.ATTRIBUTE: return createAttribute();
			case ArchitecturePackage.HARDWARE_PORT: return createHardwarePort();
			case ArchitecturePackage.SOFTWARE_CONNECTOR: return createSoftwareConnector();
			case ArchitecturePackage.HARDWARE_CONNECTOR: return createHardwareConnector();
			default:
	 ...
	 * @generated
	 */
	public CSPort createCSPort() {
		CSPortImpl csPort = new CSPortImpl();
		return csPort;
	}
